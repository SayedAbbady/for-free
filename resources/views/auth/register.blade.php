                ...
                <div class="offset-md-2 col-md-8">
                    <div class="bord">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="text" class="input form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Full name">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="email" type="text" class="form-control input @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" placeholder="0044 28123 3611">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <input id="password-confirm" placeholder="Confirm Password" type="password" class="input form-control" name="password_confirmation" required autocomplete="new-password">
                            </div>
                        </div>
